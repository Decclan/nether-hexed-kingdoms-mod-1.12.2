...
public class HumanSkeletonTop extends Block
{
	public static final AxisAlignedBB HUMAN_SKELETON_TOPAABB = new AxisAlignedBB(0.0625D, 0, 0.0625D, 0.9375D, 0.5D, 0.9375D);
	...
	public HumanSkeletonTop(String name, Material material) 
	{
		super(material);
	...
	public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block blockIn, BlockPos fromPos) 
	{
		if(!this.canBlockStay(worldIn, pos))
		{
			...
			InventoryHelper.spawnItemStack(worldIn, pos.getX(), pos.getY(), pos.getZ(), new ItemStack(ModBlocks.HUMAN_SKELETON_TOP));
		}
	}
